...
test('Create a new contact with name and e-mail', async t => {
    await t
        .typeText(contacts.contactsFrom.firstNameInput, 'Jan', { replace: true, paste: true })
        .typeText(contacts.contactsFrom.lastNameInput, 'Jansen', { replace: true, paste: true })
        .typeText(contacts.contactsFrom.emailInput, 'Jan@Jansen.nl', { replace: true, paste: true })
...
test('Update contact with a phone number newly created contact', async t => {
    await t
        ...
        .typeText(contacts.contactsFrom.phoneInput, '0612345678', { replace: true, paste: true })
